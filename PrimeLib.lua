...
function library:CreateNoity(title,default)
    local NoityByphongbigboobs1062 = Instance.new("ScreenGui")
    ...
    NoityByphongbigboobs1062.Name = "NoityByphongbigboobs#1062"
    NoityByphongbigboobs1062.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
    NoityByphongbigboobs1062.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    
    Frame.Parent = NoityByphongbigboobs1062
    Frame.BackgroundColor3 = Color3.fromRGB(38, 38, 38)
    Frame.Position = UDim2.new(-0.26, 0,0.465, 0)
    Frame.Size = UDim2.new(0, 258, 0, 46)
    ...
    TextLabel_2.Size = UDim2.new(0, 258, 0, 23)
    ...
    Frame:TweenPosition(UDim2.new(0.03, 0,0.465, 0),"Out","Linear",0.5)
    wait(2)
    Frame:TweenPosition(UDim2.new(-0.26, 0,0.465, 0),"Out","Linear",0.5)
end
...
function library:CreateWindow(name, hidebutton)
    ...
    function window:CreateTab(name)
        ...
        function tab:CreateConfigSystem(side)
            ...
            configSystem.sector = tab:CreateSector("Config Prime Hub", side or "left")
