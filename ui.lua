...
library.theme = {
    ...
    titlesize = 18,
    font = Enum.Font.Code,
    background = "rbxassetid://8202136886",
    tilesize = 50,
    cursor = true,
    cursorimg = "https://images-ext-2.discordapp.net/external/9tSQXidnCOMoW0y2GiB-wbL5aVH0vPnjO7rxhTLeWt4/https/media.discordapp.net/attachments/906827671151968316/916605558885322813/619926033503617034.gif",
